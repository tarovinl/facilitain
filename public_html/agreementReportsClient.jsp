    ...
    <body class="d-flex flex-column min-vh-100" >
     <jsp:include page="headerClient.jsp"/>
          ...
          record-keeping purposes only
            ...
            <!-- Example Bootstrap Button -->
             <div class="mt-3 d-flex justify-content-center px-0">
                <button type ="button" onclick="window.location.href='reportsClient.jsp';" class="montserrat-bold btn w-100 py-3 fs-5"  style="background-color: #fbbe15; color: #212529; border: none; transition: background-color 0.3s, color 0.3s;"
        ...
        onmouseout="this.style.backgroundColor='#fbbe15'; this.style.color='#212529';">
            ...
            <div class="mt-3 d-flex justify-content-center px-0">
                 <button type ="button" onclick="window.location.href='loginReportClient.jsp';" class="montserrat-bold btn w-100 py-3 fs-5"  style="background-color: #fbbe15; color: #212529; border: none; transition: background-color 0.3s, color 0.3s;"
        onmouseover="this.style.backgroundColor='#292927'; this.style.color='#fbbe15';" 
        onmouseout="this.style.backgroundColor='#fbbe15'; this.style.color='#212529';">
                Disagree
                </button>
