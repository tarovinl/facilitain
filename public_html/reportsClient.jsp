...
<html lang="en">
    ...
    <!-- Image Upload -->
    <label for="imageUpload" class="text-center d-block mt-3 mb-3">
    ...
    <div class="container mt-3 d-flex justify-content-center">
        ...
        <script src="https://cdn.jsdelivr.net/npms/@popperjs/core@2.11.8/dist/umd/popper.min.js" integrity="sha384-I7E8VVD/ismYTF4hNIPjVp/Zjvgyol6VFvRkX/vR+Vc4jQkC+hVqc2pM8ODewa9r" crossorigin="anonymous"></script>
