...
<body>
    <div class="d-flex vh-100">
        ...
        <div class="container-fluid mt-4">
            ...
            <!-- Hardcoded Chart (Mockup for now) -->
            <div class="card mb-4">
                <div class="card-body">
                    <h5 class="card-title">Satisfaction Rate</h5>
                    <div class="chart">
                        <!-- Hardcoded Satisfaction Rate Chart -->
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <%
                        // Mock feedback class definition
                        class Feedback {
                        ...
                        // Creating a list of feedback data
                        ...
                        // Displaying the mock feedback data
