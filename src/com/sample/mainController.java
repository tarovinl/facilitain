...
public class mainController extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try (
             ...
             PreparedStatement statement = con.prepareCall("SELECT * FROM FMO_ADM.FMO_ITEM_LOCATIONS WHERE ACTIVE_FLAG = 1 AND ARCHIVED_FLAG = 1 ORDER BY UPPER(NAME)");
             ...
             PreparedStatement stmntAllReps = con.prepareCall("SELECT repair_month, SUM(num_of_repairs) AS total_repairs FROM FMO_ADM.fmo_item_repairs WHERE repair_year = EXTRACT(YEAR FROM SYSDATE) GROUP BY repair_month ORDER BY repair_month");
                            ...
                            if (itemHIDParam != null && !itemHIDParam.isEmpty()) {
                                ...
                                try (Connection conn = PooledConnection.getConnection();
                                     PreparedStatement stmt = conn.prepareStatement(
                                         ...
                                         "JOIN FMO_ADM.FMO_ITEM_MAINTENANCE_TYPES mt ON ma.MAIN_TYPE_ID = mt.MAIN_TYPE_ID " +
