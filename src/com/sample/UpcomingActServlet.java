...
@WebServlet(name = "UpcomingActServlet", urlPatterns = { "/upcomingactservlet" })
public class UpcomingActServlet extends HttpServlet {
                ...
                try (Connection conn = PooledConnection.getConnection();
                    ...
                    try (ResultSet rs = ps.executeQuery()) {
                        ...
                        while (rs.next()) {
                            ...
                            long diffInMillis = plannedDate.getTime() - currentDate.getTime();
