...
public class reportClientController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String locationQuery = "SELECT ITEM_LOC_ID, NAME FROM FMO_ITEM_LOCATIONS WHERE ACTIVE_FLAG = 1 AND ARCHIVED_FLAG != 2 ORDER BY NAME";
        String equipmentQuery = "SELECT * FROM FMO_ITEM_CATEGORIES WHERE ARCHIVED_FLAG = 1 ORDER BY NAME";
    ...
    private void getFloorsByLocation(HttpServletRequest request, HttpServletResponse response)
        ...
        if (locationId != null && !locationId.isEmpty()) {
            String floorQuery = "SELECT DISTINCT NAME FROM FMO_ITEM_LOC_FLOORS WHERE ITEM_LOC_ID = ? AND ACTIVE_FLAG = 1 AND ARCHIVED_FLAG != 2 ORDER BY NAME";
    ...
    private void getRoomsByLocationAndFloor(HttpServletRequest request, HttpServletResponse response)
        ...
        if (locationId != null && !locationId.isEmpty() && floorNo != null && !floorNo.isEmpty()) {
            String roomQuery = "SELECT DISTINCT ROOM_NO FROM FMO_ITEMS WHERE LOCATION_ID = ? AND FLOOR_NO = ? AND ROOM_NO IS NOT NULL AND ITEM_STAT_ID != 2 ORDER BY ROOM_NO";
